...
void inicializarSeriesHardCode(eSerie series[])
{
    ...
    char nombre[][CHARSIZE]={"TBBT","TWD","GOT","BB","LCDP"};
    char genero[][CHARSIZE]={"Comedia","Terror","Suspenso","Policial","Policial"};
...
void mostrarListaSeries(eSerie series[], int SIZE){
    int i;

    printf("Series para mirar:\n");
    for(i=0;i<SIZE;i++){
